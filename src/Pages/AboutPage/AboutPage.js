                    ...
                    <div className="row mb-60">
                        <div className="col-xl-6 col-lg-8">
                            <div className="about__page-title">
                                ...
                                <h2>provide best software solutions</h2>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-xl-12">
                            <div className="about__page-area">
                                <div className="about__page-area-experience">
                                    <h3><span className="counter">{skillBar && <CountUp start={0} end={4} duration={3} delay={0}></CountUp>}+</span></h3>
